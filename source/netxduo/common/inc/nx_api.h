...
#define nx_ip_additional_link_info     nx_ip_interface[0].nx_interface_additional_link_info
    ...
    /* Define the ICMPv6 router advertisement prefix callback. */
    void        (*nx_icmpv6_ra_prefix_callback)(struct NX_IP_STRUCT *, ULONG *, ULONG);
...
#define nxd_icmpv6_ra_prefix_callback_set               _nxd_icmpv6_ra_prefix_callback_set
...
#define nxd_icmpv6_ra_prefix_callback_set               _nxde_icmpv6_ra_prefix_callback_set
...
UINT nxd_icmpv6_ra_prefix_callback_set(NX_IP *ip_ptr,
                                     VOID (*icmpv6_ra_prefix_callback)(NX_IP *ip_ptr, ULONG *prefix, ULONG prefix_length));
